<?php
/**
 * Template pour la liste des projets
 *
...
<section class="contenu row">
	...
	<header class="col-lg-9 col-sm-8 col-xs-12">
		<h1><?php echo esc_html_x( 'Projets', 'list-projects', 'platform-shell-theme' ); ?></h1>
	</header>
	...
	<article id="accueilProjets" class="col-lg-9 col-sm-8 col-xs-12 listeProjets" >
		...
		$params_array = array(
			...
			'get_query_function_name' => 'platform_shell_theme_get_published_active_query',
