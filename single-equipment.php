...
?>
			...
			<div class="col-12-xs">
				...
				?>
				<p class="label-projet"><a href="../"><i class="fa fa-chevron-left" aria-hidden="true"></i>  <?php echo esc_html_x( 'Équipements', 'single-equipment', 'platform-shell-theme' ); ?></a></p>
				</div>
...
?>
	<section class="contenu concoursDetail row">
		<p><?php echo esc_html_x( 'Problème technique', 'single-equipment', 'platform-shell-theme' ); ?></p>
	</section>
<?php endif; ?>
